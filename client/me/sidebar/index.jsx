...
const MeSidebar = createReactClass( {
	...
	// TODO: Remove dependency on following mixin
	...
	render: function() {
		...
		return (
			<Sidebar>
				...
				<div className="me-sidebar__signout sidebar__signout">
					<Button
						compact
						className="me-sidebar__signout-button sidebar__signout-button"
